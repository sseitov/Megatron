...
Public Class VSCAN
    ...
    End Function
    <DllImportAttribute("vs_can_api", EntryPoint:="VSCAN_Read")> _
    ...
    End Function
    <DllImportAttribute("vs_can_api", EntryPoint:="VSCAN_GetErrorString")> _
